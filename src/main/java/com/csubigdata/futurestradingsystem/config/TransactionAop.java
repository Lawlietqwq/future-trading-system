...
import com.csubigdata.futurestradingsystem.annotation.MainTransaction;
...
public class TransactionAop {
    ...
    @Around("@annotation(com.csubigdata.futurestradingsystem.annotation.SonTransaction)")
